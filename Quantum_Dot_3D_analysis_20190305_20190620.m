function [P,Q,S,R,r]=Quantum_Dot_3D_analysis_20190305_20190620(a,b,t)
...
%Calibration Curve works from 20190305 to 20190620 data
...
while l<=m
    ...
    P(l,5)=1169.31541+log10(1.61391/(x+0.84656)-1)/0.00313;
    l=l+1;
